...
public class NewMaterial {
    ...
    public NewMaterial(Vector4f colour, float reflectance) {
        this(colour, colour, null, reflectance);
    }

    public NewMaterial(Texture texture) {
        this(DEFAULT_COLOUR, DEFAULT_COLOUR, texture, 0);
    }

    public NewMaterial(Texture texture, float reflectance) {
        this(DEFAULT_COLOUR, DEFAULT_COLOUR, texture, reflectance);
    }

    public NewMaterial(Vector4f diffuseColour, Vector4f specularColour, float reflectance) {
        this(diffuseColour, specularColour, null, reflectance);
    }

    public NewMaterial(Vector4f diffuseColour, Vector4f specularColour, Texture texture, float reflectance) {
