...
public class NewMesh extends Mesh {
    ...
    public NewMesh(float[] positions, float[] textCoords, float[] normals, int[] indices) {
        this(positions, textCoords, normals, indices, NewMesh.createEmptyIntArray(NewMesh.MAX_WEIGHTS * positions.length / 3, 0), NewMesh.createEmptyFloatArray(NewMesh.MAX_WEIGHTS * positions.length / 3, 0));
    }

    public NewMesh(float[] positions, float[] textCoords, float[] normals, int[] indices, int[] jointIndices, float[] weights) {
        super();
